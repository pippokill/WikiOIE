...
public class ExpFullVector {
    ...
    public static void main(String[] args) {
        try {
            ...
            Appendable out = new FileWriter("./preds_vec.csv");
            ...
            out = new FileWriter("./subjs_vec.csv");
            ...
            out = new FileWriter("./objs_vec.csv");
            printer = CSVFormat.DEFAULT.print(out);
            for (String q : objs) {
                printer.printRecord(q, "", "");
            ...
            Logger.getLogger(ExpFullVector.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
