 ...
 * @author pierpaolo
 */
public class CoTrainingXGboost {
     ...
     * @throws ml.dmlc.xgboost4j.java.XGBoostError
     */
    public void cotraining(File annotatedFile, File dataFile, String outputdir, VectorReader vr, int p, int maxit) throws IOException, XGBoostError {
        UDPParser parser = new UDPParser(Config.getInstance().getValue("udp.address"), Config.getInstance().getValue("udp.model"));
        WikiExtractor ie = new WikiITSimpleDepExtractor();
     ...
     * @throws IOException
     */
    public void cotraining(File annotatedFile, File dataFile, String outputdir, int p, int maxit) throws IOException, XGBoostError {
        cotraining(annotatedFile, dataFile, outputdir, null, p, maxit);
    }
     ...
     * @throws IOException
     */
    public void trainAndTest(File trainFile, File testFile) throws IOException, XGBoostError {
        trainAndTest(trainFile, testFile, null);
    }
